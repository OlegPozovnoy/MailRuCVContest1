...
def parse_arguments():
    ...
    parser.add_argument("--batch-size", "-b", default=32, type=int)  # 512 is OK for resnet18 finetune @ 6Gb of VRAM
...
def main(args):
    ...
    print("Reading data...")
    #sampler = data.BatchSampler(batch_size=args.batch_size, drop_last=False)
    ...
    torch.save(model, os.path.join(args.data, 'model'))
    print("OK")
